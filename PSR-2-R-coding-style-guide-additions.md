...
Данный документ имеет приоритет перед PSR-1 и PSR-2 в случае противоречий.

## Classes, Properties and variables.

* Имена классов, неймспейсов, интерфейсов, трейтов используют `UpperCamelCase`
...
* Не импортируем много классов из одного неймспейса, предпочитая импортировать базовый
